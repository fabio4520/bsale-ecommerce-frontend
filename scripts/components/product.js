...
export function ProductComponent(product) {
  ...
  return `
  <div class='flex flex-col h-full bg-white p-8 rounded-xl gap-y-4 cursor-pointer hover:scale-105 hover:duration-100'>
    ...
    <div class='flex flex-col gap-y-3'>
      ...
      <div class="flex">
        ...
        <p class='text-slate-400 ml-16'>-${product.discount}%</p>
      </div>
